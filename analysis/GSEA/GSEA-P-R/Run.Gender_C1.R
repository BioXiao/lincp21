...
GSEA(                                                                      # Input/Output Files :-------------------------------------------
 input.ds =  "d:/CGP2005/GSEA/GSEA-P-R/Datasets/Gender.gct",               # Input gene expression Affy dataset file in RES or GCT format
 input.cls = "d:/CGP2005/GSEA/GSEA-P-R/Datasets/Gender.cls",               # Input class vector (phenotype) file in CLS format
 gs.db =     "d:/CGP2005/GSEA/GSEA-P-R/GeneSetDatabases/C1.gmt",           # Gene set database in GMT format
 output.directory      = "d:/CGP2005/GSEA/GSEA-P-R/Gender_C1/",            # Directory where to store output and results (default: "")
#  Program parameters :----------------------------------------------------------------------------------------------------------------------------
