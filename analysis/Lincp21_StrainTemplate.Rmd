...
if(length(isoformSigIDs)>0){
  isoformSigGenes<-getGenes(cuff,isoformSigIDs, level="isoforms")
...
```{r GSEA_all, fig.width=10, fig.height=16}
InputCols<-maPalette(low="white",high="red",k=100)
...
```{r gsea_enrich_fig, fig.width=8, fig.height=16}
...
```{r gsea_zscore_fig, fig.width=8, fig.height=16}
#ALL zscore: 
